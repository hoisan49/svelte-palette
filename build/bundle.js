    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 52, 12, 1321);
    			attr_dev(input0, "type", "checkbox");
    			attr_dev(input0, "class", "svelte-58wdgu");
    			add_location(input0, file, 56, 20, 1447);
    			attr_dev(label0, "class", "svelte-58wdgu");
    			add_location(label0, file, 54, 16, 1380);
    			attr_dev(fieldset0, "class", "svelte-58wdgu");
    			add_location(fieldset0, file, 53, 12, 1352);
    			attr_dev(input1, "type", "checkbox");
    			attr_dev(input1, "class", "svelte-58wdgu");
    			add_location(input1, file, 62, 20, 1662);
    			attr_dev(label1, "class", "svelte-58wdgu");
    			add_location(label1, file, 60, 16, 1594);
    			attr_dev(fieldset1, "class", "svelte-58wdgu");
    			add_location(fieldset1, file, 59, 12, 1566);
    			attr_dev(input2, "type", "checkbox");
    			attr_dev(input2, "class", "svelte-58wdgu");
    			add_location(input2, file, 68, 20, 1877);
    			attr_dev(label2, "class", "svelte-58wdgu");
    			add_location(label2, file, 66, 16, 1809);
    			attr_dev(fieldset2, "class", "svelte-58wdgu");
    			add_location(fieldset2, file, 65, 12, 1781);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "class", "svelte-58wdgu");
    			add_location(input3, file, 74, 20, 2091);
    			attr_dev(label3, "class", "svelte-58wdgu");
    			add_location(label3, file, 72, 16, 2025);
    			attr_dev(fieldset3, "class", "svelte-58wdgu");
    			add_location(fieldset3, file, 71, 12, 1997);
    			attr_dev(input4, "type", "checkbox");
    			attr_dev(input4, "class", "svelte-58wdgu");
    			add_location(input4, file, 80, 20, 2313);
    			attr_dev(label4, "class", "svelte-58wdgu");
    			add_location(label4, file, 78, 16, 2237);
    			attr_dev(fieldset4, "class", "svelte-58wdgu");
    			add_location(fieldset4, file, 77, 12, 2209);
    			attr_dev(input5, "type", "checkbox");
    			attr_dev(input5, "class", "svelte-58wdgu");
    			add_location(input5, file, 86, 20, 2545);
    			attr_dev(label5, "class", "svelte-58wdgu");
    			add_location(label5, file, 84, 16, 2467);
    			attr_dev(fieldset5, "class", "svelte-58wdgu");
    			add_location(fieldset5, file, 83, 12, 2439);
    			attr_dev(input6, "type", "checkbox");
    			attr_dev(input6, "class", "svelte-58wdgu");
    			add_location(input6, file, 92, 20, 2774);
    			attr_dev(label6, "class", "svelte-58wdgu");
    			add_location(label6, file, 90, 16, 2701);
    			attr_dev(fieldset6, "class", "svelte-58wdgu");
    			add_location(fieldset6, file, 89, 12, 2673);
    			attr_dev(input7, "type", "number");
    			attr_dev(input7, "min", "1");
    			attr_dev(input7, "max", "30");
    			attr_dev(input7, "class", "svelte-58wdgu");
    			add_location(input7, file, 98, 20, 2988);
    			attr_dev(label7, "class", "svelte-58wdgu");
    			add_location(label7, file, 96, 16, 2926);
    			attr_dev(fieldset7, "class", "svelte-58wdgu");
    			add_location(fieldset7, file, 95, 12, 2898);
    			attr_dev(form, "class", "settings__form svelte-58wdgu");
    			add_location(form, file, 51, 8, 1278);
    			attr_dev(div, "class", "container svelte-58wdgu");
    			add_location(div, file, 38, 4, 675);
    			set_style(main, "--bgColor", /*bgColor*/ ctx[0]);
    			attr_dev(main, "class", "svelte-58wdgu");
    			add_location(main, file, 37, 0, 635);
    			attr_dev(button, "class", "palette__tooltip__button");
    			add_location(button, file, 105, 0, 3143);
    		},
